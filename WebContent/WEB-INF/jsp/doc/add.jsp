...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/css/doc/add.css" />
...
<body>
	...
	<sf:form id="name" method="post" modelAttribute="documentForm"  enctype="multipart/form-data">
        	...
        	<thead><tr><td colspan="2">文档添加</td></tr></thead>
			<tr>
				<td class="tableHeader">文档名称:</td> <td><sf:input path="name" name="name"/> </td>
			</tr>
			<tr>
			...
			<tr>
				<td class="tableHeader">文档路径:</td> <td> <sf:input path="path" name="path"/> </td>
			</tr>
				 <sf:hidden path="creater" name="creater" value= "${loginUser.username}" /> 
			<tr>
				<td class="tableHeader">上传文件</td>
			...
			<tr>
				<td colspan="2"> <input type="submit" value="文档添加" /><input type="reset" /> </td>
			</tr>
		</table>
	</sf:form>
    </div>
